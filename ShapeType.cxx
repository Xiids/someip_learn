...
ShapeTypeExtended::ShapeTypeExtended (
    ...
    float angle)
    :
        ShapeType(color,x,y,z,shapesize ),
    ...
    namespace topic {
        ...
        struct native_type_code< ShapeType > {
            static DDS_TypeCode * get()
            {
                ...
                static DDS_TypeCode_Member ShapeType_g_tc_members[5]=
                {
                ...
                ShapeType_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
                ...
                ShapeType_g_tc_members[4]._annotations._defaultValue._d = RTI_XCDR_TK_LONG;
                ShapeType_g_tc_members[4]._annotations._defaultValue._u.long_value = 0;
                ShapeType_g_tc_members[4]._annotations._minValue._d = RTI_XCDR_TK_LONG;
                ShapeType_g_tc_members[4]._annotations._minValue._u.long_value = RTIXCdrLong_MIN;
                ShapeType_g_tc_members[4]._annotations._maxValue._d = RTI_XCDR_TK_LONG;
                ShapeType_g_tc_members[4]._annotations._maxValue._u.long_value = RTIXCdrLong_MAX;
            ...
            static RTIXCdrSampleAccessInfo * sample_access_info()
            {
                ...
                static RTIXCdrMemberAccessInfo ShapeType_g_memberAccessInfos[5] =
                {RTIXCdrMemberAccessInfo_INITIALIZER};
                ...
                ShapeType_g_memberAccessInfos[4].bindingMemberValueOffset[0] = 
